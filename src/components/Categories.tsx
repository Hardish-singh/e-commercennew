...
const Categories = () => {
  return (
    <section className="w-full bg-black py-6 px-4">
      ...
      <div className="block md:hidden text-center text-yellow-400 text-3xl font-bold mb-6 animate-bounce">
        Categories
      </div>
      ...
      <div className="flex flex-row justify-around items-center w-full gap-4">
        ...
        <div className="flex flex-col justify-center items-center group transition-transform duration-300 hover:scale-105">
          ...
          />
          <div className="text-white text-sm md:text-lg font-semibold mt-2 group-hover:text-yellow-300 transition">
            Women
          </div>
        </div>
        ...
        <div className="hidden md:flex flex-col justify-center items-center animate-fade-in">
          <div className="text-yellow-400 text-6xl font-bold">Categories</div>
        </div>
